...
struct  RegistrationBotData {
    static let registrationBotModel: [RegistrationBotModel] = [
       /* RegistrationBotModel(viewDescription: "national register"),*/
        ...
        RegistrationBotModel(msgToFill: "Let’s start with some personal details. Firstly, your First name.", msgToFillBold: Constant.Texts.firstName),
        ...
        RegistrationBotModel(msgToFill: "Now, mention your Last name.", msgToFillBold:Constant.Texts.lastName),
        ...
        RegistrationBotModel(msgToFill: "Insert your Phone number, please.", msgToFillBold: Constant.Texts.phoneNumber),
        RegistrationBotModel(viewDescription: Constant.Texts.phone),
        RegistrationBotModel(msgToFill: "Date of birth, maybe there are some promotions on your specific day.", msgToFillBold:Constant.Texts.dateOfBirth),
        ...
        RegistrationBotModel(msgToFill: "Step 2 - House number.", msgToFillBold: Constant.Texts.houseNumber),
        ...
        RegistrationBotModel(msgToFill: "Step 3 - Mailbox number, if you’re living in an apartment building.", msgToFillBold: Constant.Texts.mailboxNumber),
        ...
        RegistrationBotModel(msgToFill: "Step 4 - Country.", msgToFillBold: Constant.Texts.country),
        ...
        RegistrationBotModel(msgToFill: "Step 5 - Zip number.", msgToFillBold: Constant.Texts.zipNumber),
        ...
        RegistrationBotModel(msgToFill: "Step 6 - City.", msgToFillBold: Constant.Texts.city),
        ...
        RegistrationBotModel(msgToFill: "Please, insert your National register number.", msgToFillBold: Constant.Texts.nationalRegisterNum),
        ...
        RegistrationBotModel(viewDescription: "takePhoto"),
        RegistrationBotModel(msgToFill: "Now, let’s add the Expiry date.", msgToFillBold: Constant.Texts.expiryDate),
        RegistrationBotModel(viewDescription: Constant.Texts.expiry_date),
        RegistrationBotModel(msgToFill: "Now, let’s add the Driving license number.", msgToFillBold: Constant.Texts.licenseNumber),
        ...
        RegistrationBotModel(msgToFill: "Now let’s add the Expiry date of Driving license.", msgToFillBold: Constant.Texts.expiryDrivingLic),
        RegistrationBotModel(viewDescription: Constant.Texts.expiryDateDrivingLicense),
        RegistrationBotModel(msgToFill: "Last one left. Please, take a selfie photo with your valid Driving license, like this one.", msgToFillBold: Constant.Texts.selfi_driving_lic),
        RegistrationBotModel(examplePhoto: #imageLiteral(resourceName: "selfie")),
        RegistrationBotModel(viewDescription: "takePhoto"),
        RegistrationBotModel(msgToFill: "Please, examine carefully the online version of the licensed BKD Agreement. By clicking “Agree”, you agree to our Terms & Conditions.", msgToFillBold: Constant.Texts.bkdAgree),
    ...
    static let registrationDriverModel: [RegistrationBotModel] = [RegistrationBotModel(msgToFill: "Hello. I’m the BKD robot. I help new users register fast and fun."),
        ...
        RegistrationBotModel(viewDescription: Constant.Texts.button, userRegisterInfo: UserRegisterInfo(string: "Start")),
                                                                  RegistrationBotModel(msgToFill: "Let’s start with some personal details. Firstly, your additional driver’s First name.", msgToFillBold: Constant.Texts.firstName),
        RegistrationBotModel(msgToFill: "P.S. You should use real names on BKD."),
        RegistrationBotModel(viewDescription: Constant.Texts.txtFl, userRegisterInfo: UserRegisterInfo(placeholder: Constant.Texts.name)),
                                                                  RegistrationBotModel(msgToFill: "Now, mention your additional driver’s Last name.", msgToFillBold: Constant.Texts.lastName),
        RegistrationBotModel(viewDescription: Constant.Texts.txtFl, userRegisterInfo: UserRegisterInfo(placeholder: Constant.Texts.surname)),
                                                                  RegistrationBotModel(msgToFill: "Insert your additional driver’s Phone number, please.", msgToFillBold: Constant.Texts.phoneNumber),
        RegistrationBotModel(viewDescription:  Constant.Texts.phone),
                                                                  RegistrationBotModel(msgToFill: "Date of birth, maybe there are some promotions on your additional driver’s specific day.", msgToFillBold:Constant.Texts.dateOfBirth),
        RegistrationBotModel(viewDescription: Constant.Texts.calendar, userRegisterInfo: UserRegisterInfo(placeholder: Constant.Texts.dateOfBirth)),
        ...
        RegistrationBotModel(msgToFill: "Your additional driver’s Address is registered successfully."),
                                                                  RegistrationBotModel(msgToFill: "Please, insert your additional driver’s National register number.", msgToFillBold: Constant.Texts.nationalRegisterNum),
        RegistrationBotModel(viewDescription: Constant.Texts.nationalRegister),
        RegistrationBotModel(msgToFill: "Last Registration Step is to attach Documents."),
        RegistrationBotModel(msgToFill: "Documents should be captured fully, as well as the information on them must be easily readable."),
                                                                  RegistrationBotModel(msgToFill: "First, take the front side photo of your additional driver’s Identity card (Photo holder side).", msgToFillBold: Constant.Texts.fron_addDriving_id),
        RegistrationBotModel(viewDescription: "takePhoto"),
                                                                  RegistrationBotModel(msgToFill: "Now, take the back side photo of your additional driver’s Identity card.", msgToFillBold: Constant.Texts.back_addDriving_Id),
        RegistrationBotModel(viewDescription: "takePhoto"),
        RegistrationBotModel(msgToFill: "Now, let’s add the Expiry date.", msgToFillBold: Constant.Texts.expiryDate),
        RegistrationBotModel(viewDescription: Constant.Texts.expiry_date),
        RegistrationBotModel(msgToFill: "Now, let’s add the Driving license number.", msgToFillBold: Constant.Texts.licenseNumber),
        RegistrationBotModel(viewDescription: Constant.Texts.txtFl, userRegisterInfo: UserRegisterInfo(placeholder: Constant.Texts.drivingLicenseNumber)),
                                                                  RegistrationBotModel(msgToFill: "Please, take the front side photo of your additional driver’s valid Driving license (Photo holder side).", msgToFillBold: Constant.Texts.fron_addDriving_lic),
        RegistrationBotModel(viewDescription: "takePhoto"),
                                                                  RegistrationBotModel(msgToFill: "Now, take the back side photo of your additional driver’s valid Driving license.", msgToFillBold: Constant.Texts.back_addDriving_lic),
        RegistrationBotModel(viewDescription: "takePhoto"),
                                                                  RegistrationBotModel(msgToFill: "Now let’s add the Issue date of the Driving license.", msgToFillBold:Constant.Texts.license_issue_text),
        RegistrationBotModel(viewDescription: Constant.Texts.issueDateDrivingLicense),
                                                                  RegistrationBotModel(msgToFill: "Now let’s add the Expiry date of Driving license.", msgToFillBold: Constant.Texts.expiryDrivingLic),
        RegistrationBotModel(viewDescription: Constant.Texts.expiryDateDrivingLicense),
                                                                  RegistrationBotModel(msgToFill: "Last one left. Please, ask your additional driver take a selfie photo with your valid Driving license, like this one.", msgToFillBold: Constant.Texts.selfi_driving_lic),
        RegistrationBotModel(examplePhoto: #imageLiteral(resourceName: "selfie")),
        RegistrationBotModel(viewDescription: "takePhoto"),
        RegistrationBotModel(msgToFill: "Please, examine carefully the online version of the licensed BKD Agreement. By clicking “Agree”, you agree to our Terms & Conditions.", msgToFillBold: Constant.Texts.bkdAgree),
        RegistrationBotModel(viewDescription: "openDoc"),
