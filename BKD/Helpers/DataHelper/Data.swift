...
struct  RegistrationBotData {
    static let registrationBotModel: [RegistrationBotModel] = [
       /* RegistrationBotModel(viewDescription: "national register"),*/
        ...
        RegistrationBotModel(viewDescription: "calendar", userRegisterInfo: UserRegisterInfo(placeholder: Constant.Texts.dateOfBirth)),
        ...
        RegistrationBotModel(viewDescription: "calendar_expire"),
